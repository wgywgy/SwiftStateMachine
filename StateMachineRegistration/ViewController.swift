...
class ViewController: UIViewController {
    ...
    lazy var createProfileViewController: CreateProfileViewController = UIStoryboard(name: "Main", bundle: Bundle(for: ViewController.self)).instantiateViewController(withIdentifier: "CreateProfileViewController") as! CreateProfileViewController
    lazy var facebookProfileViewController: FacebookProfileViewController = UIStoryboard(name: "Main", bundle: Bundle(for: ViewController.self)).instantiateViewController(withIdentifier: "FacebookProfileViewController") as! FacebookProfileViewController
    lazy var selectAvatarViewController: SelectAvatarViewController = UIStoryboard(name: "Main", bundle: Bundle(for: ViewController.self)).instantiateViewController(withIdentifier: "SelectAvatarViewController") as! SelectAvatarViewController
    lazy var termsAndConditionsViewController: TermsAndConditionsViewController = UIStoryboard(name: "Main", bundle: Bundle(for: ViewController.self)).instantiateViewController(withIdentifier: "TermsAndConditionsViewController") as! TermsAndConditionsViewController
...
extension ViewController {
	...
	@IBAction func didTapLogin(sender: AnyObject) {
        notifyStateMachine(source: self, .Login)
	}
